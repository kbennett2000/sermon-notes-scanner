...
/**
 * Interface for managing collections of scans within the application.
 * Provides methods to create, retrieve, modify, and delete collections,
 * as well as to manage the relationships between collections and scans.
 */
